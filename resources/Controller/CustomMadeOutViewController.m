...
- (IBAction)doAction:(id)sender
{
    ...
    float countUpdate = ceil([receiptProductItemList count]/itemsPerConnection);
    for(int i=0; i<countUpdate; i++)
    {
        NSInteger startIndex = i * itemsPerConnection;
        NSInteger count = MIN([receiptProductItemList count] - startIndex, itemsPerConnection );
        NSArray *subArray = [receiptProductItemList subarrayWithRange: NSMakeRange( startIndex, count )];
